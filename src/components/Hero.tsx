      ...
      <div className="relative z-10 w-full px-4 sm:px-6 md:px-8 max-w-7xl mx-auto max-md:mt-36">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            {/* Título */}
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-extrabold text-white">
            ...
            {/* Descrição */}
            <p className="text-gray-300 text-base sm:text-lg max-w-xl mx-auto lg:mx-0 font-semibold">
              Um guia prático para organizar o início, evitar erros caros e começar com segurança, mesmo com pouco dinheiro.
            </p>

            {/* CTA */}
            <button className="w-full sm:w-auto mx-auto lg:mx-0 bg-[#C2FF73] hover:bg-[#C2FF73]/90 text-black font-bold py-4 px-8 rounded-lg transition-all transform hover:scale-105 flex items-center justify-center gap-2 text-base sm:text-lg shadow-[0_0_25px_rgba(194,255,115,0.25)]">
