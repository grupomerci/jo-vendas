      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Este material não é para todo mundo. Veja se ele se encaixa no seu
            momento.
          </p>
        </div>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={index} className="flex items-start gap-3">
                  <div className="mt-1 min-w-[20px] text-lime-500">
                    <Check size={20} />
                  </div>
        ...
        <div className="mt-12 text-center">
          <div className="inline-block bg-lime-50 border border-lime-200 rounded-lg p-4 max-w-2xl mx-auto">
